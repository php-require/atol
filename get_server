...
$atol = new AtolWebDriver('192.168.8.215');
...
$items = [];
$items[] = ['name'=>'Стакан одноразовый','price'=>0.6,'quantity'=>1];
$items[] = ['name'=>'массаж','price'=>0.4,'quantity'=>1];
